                                                    ...
                                                    <td width="50">
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-right">
                                                                <li><a href="<?php echo site_url('parameters/edit/' . $row->id); ?>"><i class="fa fa-pencil fa-fw"></i> Edit</a></li>
                                                                <li><a onclick="javascript: if(!confirm('Anda yakin mau hapus data?')) return false;" href="<?php echo site_url('parameters/delete/' . $row->id); ?>"><i class="fa fa-trash fa-fw"></i> Delete</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
